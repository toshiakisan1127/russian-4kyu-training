...
export const mockExam1 = {
  ...
  title: '模擬試験 第1回',
  durationMinutes: 60,
  totalQuestionCards: 65,
  totalAnswerFields: 76,
  sections: [
    {
      id: 'mock-1-section-1',
      roman: 'I',
      ...
      questions: [
        {
          ...
          id: 'mock-1-s10-01',
          selfGrade: true,
          prompt: '毎週日曜日、私たちは祖母の家へ歩いて行きます。',
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'Ка́ждое воскресе́нье мы хо́дим пешко́м к ба́бушке.',
              explanation: 'каждое воскресенье は「毎週日曜日に」。ходить пешком は「歩いて行く」。к + 与格の к бабушке は「祖母のところへ」。',
              multiline: true,
            },
          ],
          speechText: 'Ка́ждое воскресе́нье мы хо́дим пешко́м к ба́бушке.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-02',
          selfGrade: true,
          prompt: '昨日、オレグは学校で友だちとロシア語を話しました。',
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'Вчера́ Оле́г говори́л в шко́ле с дру́гом по-ру́сски.',
              explanation: 'вчера́ は「昨日」。говорить по-русски は「ロシア語を話す」。с другом は「友だちと」。',
              multiline: true,
            },
          ],
          speechText: 'Вчера́ Оле́г говори́л в шко́ле с дру́гом по-ру́сски.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-03',
          selfGrade: true,
          prompt: '明日の朝、彼女はバスで仕事へ行くでしょう。',
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'За́втра у́тром она́ пое́дет на рабо́ту на авто́бусе.',
              explanation: 'завтра утром は「明日の朝」。пое́дет は ехать の未来形で「乗り物で行くでしょう」。на работу は「仕事へ」、на автобусе は「バスで」。',
              multiline: true,
            },
          ],
          speechText: 'За́втра у́тром она́ пое́дет на рабо́ту на авто́бусе.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-04',
          selfGrade: true,
          prompt: '私たちの教室には大きな窓があります。',
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'У нас в кла́ссе есть большо́е окно́.',
              explanation: 'у нас есть は「私たちには〜がある」。в классе は「教室に」。окно́ は中性名詞なので большо́е になります。',
              multiline: true,
            },
          ],
          speechText: 'У нас в кла́ссе есть большо́е окно́.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-05',
          selfGrade: true,
          prompt: '私は夏に海で泳ぐのが好きです。',
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'Ле́том я люблю́ пла́вать в мо́ре.',
              explanation: 'летом は「夏に」。любить + 不定形は「〜するのが好き」。в море は「海で／海に」。',
              multiline: true,
            },
          ],
          speechText: 'Ле́том я люблю́ пла́вать в мо́ре.',
        },
      ],
    },
  ] as MockSection[],
