      ...
      questions: [
        {
          ...
          id: 'mock-1-s9-01',
          selfGrade: true,
          prompt: 'Меня зовут Дима. Я живу с родителями и младшей сестрой в небольшом доме недалеко от города. Утром я обычно встаю в семь часов и помогаю маме готовить завтрак. Потом я иду в школу пешком. После уроков я встречаюсь с друзьями во дворе или читаю книгу дома. По субботам мы всей семьёй ездим на рынок. Мама покупает овощи, а папа выбирает рыбу. Вечером сестра рисует в своей комнате, а я делаю домашнее задание.',
          fields: [
            {
              id: 'answer',
              label: '自分の日本語訳',
              answer: '私の名前はディーマです。私は両親と妹と一緒に、町から遠くない小さな家に住んでいます。朝、私はたいてい7時に起きて、母が朝食を作るのを手伝います。それから歩いて学校へ行きます。授業の後、私は中庭で友だちと会うか、家で本を読みます。毎週土曜日、私たちは家族全員で市場へ行きます。母は野菜を買い、父は魚を選びます。夜、妹は自分の部屋で絵を描き、私は宿題をします。',
              explanation: 'жить с + 造格は「〜と一緒に住む」。недалеко от + 生格は「〜から遠くない」。помогать маме は与格で「母を手伝う」。пешком は「徒歩で」、после уроков は「授業の後」。всей семьёй は「家族全員で」を表す。',
              multiline: true,
            },
          ],
          translation: '私の名前はディーマです。私は両親と妹と一緒に、町から遠くない小さな家に住んでいます。朝、私はたいてい7時に起きて、母が朝食を作るのを手伝います。それから歩いて学校へ行きます。授業の後、私は中庭で友だちと会うか、家で本を読みます。毎週土曜日、私たちは家族全員で市場へ行きます。母は野菜を買い、父は魚を選びます。夜、妹は自分の部屋で絵を描き、私は宿題をします。',
          speechText: 'Меня́ зову́т Ди́ма. Я живу́ с роди́телями и мла́дшей сестро́й в небольшо́м до́ме недалеко́ от го́рода. У́тром я обы́чно встаю́ в семь ча́сов и помога́ю ма́ме гото́вить за́втрак. По́том я иду́ в шко́лу пешко́м. По́сле уро́ков я встреча́юсь с друзья́ми во дворе́ и́ли чита́ю кни́гу до́ма. По суббо́там мы всей семьёй е́здим на ры́нок. Ма́ма покупа́ет о́вощи, а па́па выбира́ет ры́бу. Ве́чером сестра́ рису́ет в свое́й ко́мнате, а я де́лаю дома́шнее зада́ние.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          id: 'mock-1-s10-01',
          selfGrade: true,
          prompt: '毎週土曜日、私は市場で果物を買います。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'Ка́ждую су́бботу я покупа́ю фру́кты на ры́нке.', explanation: 'каждую субботу は「毎週土曜日」。фрукты は複数対格、на рынке は場所の前置格。', multiline: true }],
          speechText: 'Ка́ждую су́бботу я покупа́ю фру́кты на ры́нке.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-02',
          selfGrade: true,
          prompt: '夕方、姉は宿題をして、そのあと音楽を聞きます。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'Ве́чером моя́ ста́ршая сестра́ де́лает дома́шнее зада́ние, а пото́м слу́шает му́зыку.', explanation: 'вечером は「夕方に」。домашнее задание は「宿題」。а потом は「そしてそのあと」。музыку は музыка の対格。', multiline: true }],
          speechText: 'Ве́чером моя́ ста́ршая сестра́ де́лает дома́шнее зада́ние, а пото́м слу́шает му́зыку.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-03',
          selfGrade: true,
          prompt: '先週、私たちは妹に写真を送りました。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'На про́шлой неде́ле мы отпра́вили фотогра́фии мла́дшей сестре́.', explanation: 'на прошлой неделе は「先週」。отправить は完了体過去形。младшей сестре は与格で「妹に」、фотографии は対格。', multiline: true }],
          speechText: 'На про́шлой неде́ле мы отпра́вили фотогра́фии мла́дшей сестре́.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-04',
          selfGrade: true,
          prompt: '駅の前に小さなカフェがあります。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'Пе́ред вокза́лом есть ма́ленькое кафе́.', explanation: 'перед + 造格は「〜の前に」。вокзалом は вокзал の造格。есть は「ある・いる」。маленькое は кафе́ に合わせた中性形。', multiline: true }],
          speechText: 'Пе́ред вокза́лом есть ма́ленькое кафе́.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-05',
          selfGrade: true,
          prompt: '来週、私の家族はバスで海へ行きます。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'На сле́дующей неде́ле моя́ семья́ пое́дет к мо́рю на авто́бусе.', explanation: 'на следующей неделе は「来週」。семья は女性名詞なので поедет。к морю は「海へ」、на автобусе は「バスで」。', multiline: true }],
          speechText: 'На сле́дующей неде́ле моя́ семья́ пое́дет к мо́рю на авто́бусе.',
        },
      ],
    },
  ] as MockSection[],
