    ...
    },
    {
      ...
      questions: [
          ...
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'По́сле рабо́ты оте́ц обы́чно покупа́ет проду́кты в магази́не.',
              explanation: 'по́сле + 生格は「〜の後」。оте́ц は「父」、обы́чно は「たいてい」、в магази́не は場所の前置格。',
              multiline: true,
            },
          ],
          speechText: 'По́сле рабо́ты оте́ц обы́чно покупа́ет проду́кты в магази́не.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-04',
        ...
        },
        {
          ...
          id: 'mock-1-s10-05',
          selfGrade: true,
          prompt: '明日、私たちは友人の誕生日パーティーに電車で行きます。',
          fields: [
            {
              id: 'answer',
              label: '自分のロシア語訳',
              answer: 'За́втра мы пое́дем на день рожде́ния к дру́гу на по́езде.',
              explanation: 'пое́дем は пое́хать の一人称複数未来形。「電車で」は на по́езде、на день рожде́ния は「誕生日パーティーに」、к + 与格は「〜のところへ」を表す。',
              multiline: true,
            },
          ],
          speechText: 'За́втра мы пое́дем на день рожде́ния к дру́гу на по́езде.',
        },
      ],
    },
  ] as MockSection[],
