      ...
      questions: [
        {
          ...
          id: 'mock-1-s10-01',
          selfGrade: true,
          prompt: '私の頭が痛いので、私は家にいます。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'У меня́ бо́лит голова́, поэ́тому я остаю́сь до́ма.', explanation: 'у меня́ болит голова́ は「私の頭が痛い」、поэ́тому は「だから・そのため」。остава́ться は「とどまる・家にいる」。', multiline: true }],
          speechText: 'У меня́ бо́лит голова́, поэ́тому я остаю́сь до́ма.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-02',
          selfGrade: true,
          prompt: '日曜日、私たちは歩いて公園へ行きます。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'В воскресе́нье мы пойдём в па́рк пешко́м.', explanation: 'пойдём は идти́「歩いて行く」の一人称複数の未来形。в парк は行き先を表す対格、пешко́м は「徒歩で」。', multiline: true }],
          speechText: 'В воскресе́нье мы пойдём в па́рк пешко́м.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-03',
          selfGrade: true,
          prompt: '明日、私たちはバスで学校へ行きます。',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'За́втра мы пое́дем в шко́лу на авто́бусе.', explanation: 'пое́дем は пое́хать「乗り物で行く」の一人称複数の未来形。в школу は行き先、на автобусе は「バスで」。', multiline: true }],
          speechText: 'За́втра мы пое́дем в шко́лу на авто́бусе.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-04',
          selfGrade: true,
          prompt: '「君はどこへ行くの？」「私は学校へ行くよ。」',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: '— Куда́ ты идёшь? — Я иду́ в шко́лу.', explanation: 'куда́ は「どこへ」。идёшь と иду́ は идти́「歩いて行く」の現在形。в школу は移動の行き先を表す対格。', multiline: true }],
          speechText: '— Куда́ ты идёшь? — Я иду́ в шко́лу.',
        },
        {
          kind: 'input',
          id: 'mock-1-s10-05',
          selfGrade: true,
          prompt: '「君たちは明日どうやって公園へ行くの？」「私たちは電車で行くよ。」',
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: '— Как вы пое́дете за́втра в па́рк? — Мы пое́дем на по́езде.', explanation: 'как は「どのように・どうやって」。пое́дете は ехать́/поехать́ 系の二人称複数未来形、пое́дем は一人称複数未来形。на по́езде は「電車で」。', multiline: true }],
          speechText: '— Как вы пое́дете за́втра в па́рк? — Мы пое́дем на по́езде.',
        },
      ],
    },
  ] as MockSection[],
