    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: '— Как вы пое́дете за́втра в па́рк? — Мы пое́дем на по́езде.', explanation: 'как は「どのように・どうやって」。пое́дете は ехать/поехать 系の二人称複数未来形、пое́дем は一人称複数未来形。на по́езде は「電車で」。', multiline: true }],
