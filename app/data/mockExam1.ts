      ...
      questions: [
        {
          ...
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'У меня́ бо́лит нога́, поэ́тому я сижу́ на скаме́йке.', explanation: 'у меня́ болит нога́ は「私の足が痛い」、поэ́тому は「だから・そのため」。сидеть は「座っている」、на скамейке は「ベンチに」を表す。', multiline: true }],
        ...
        },
        {
          ...
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: '— Где ты живёшь? — Я живу́ в То́кио.', explanation: 'где は「どこに」。жить は「住む」で、ты живёшь と я живу́ は現在形。в Токио は場所を表す前置格。', multiline: true }],
        ...
        },
        {
          ...
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'Ка́ждое у́тро ма́ма пьёт ко́фе.', explanation: 'каждое утро は「毎朝」。пить は「飲む」。ма́ма に対応する現在形は пью́т ではなく пьёт。', multiline: true }],
        ...
        },
        {
          ...
          fields: [{ id: 'answer', label: '自分のロシア語訳', answer: 'Вчера́ А́нна написа́ла письмо́ ма́ме.', explanation: 'вчера́ は「昨日」。написать は完了体過去形で「書き終えた・書いた」。ма́ме は мать「母」の与格。', multiline: true }],
