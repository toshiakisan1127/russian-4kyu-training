...
const motionSeeds: ExtraQuestion[] = [
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて学校へ行く', prompt: 'Сейча́с я ___ в шко́лу.', correctAnswer: 'иду́', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Сейча́с я иду́ в шко́лу.', answerTranslation: '今、私は歩いて学校へ向かっています。', explanation: '今まさに一方向へ歩いて移動しているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '毎日、歩いて学校へ通う', prompt: 'Я ка́ждый день ___ в шко́лу пешко́м.', correctAnswer: 'хожу́', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Я ка́ждый день хожу́ в шко́лу пешко́м.', answerTranslation: '私は毎日、歩いて学校へ通っています。', explanation: '習慣的・反復的に歩いて行くので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '今、電車でモスクワへ向かう', prompt: 'Сейча́с мы ___ в Москву́ на по́езде.', correctAnswer: 'е́дем', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Сейча́с мы е́дем в Москву́ на по́езде.', answerTranslation: '今、私たちは電車でモスクワへ向かっています。', explanation: '今まさに一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '頻繁に、電車でモスクワへ行く', prompt: 'Мы ча́сто ___ в Москву́ на по́езде.', correctAnswer: 'е́здим', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы ча́сто е́здим в Москву́ на по́езде.', answerTranslation: '私たちはよく電車でモスクワへ行きます。', explanation: '繰り返し乗り物で行くので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いてどこへ行くかを尋ねる', prompt: 'Куда́ ты сейча́с ___?', correctAnswer: 'идёшь', choices: ['идёшь', 'хо́дишь', 'е́дешь', 'е́здишь'], answerSentence: 'Куда́ ты сейча́с идёшь?', answerTranslation: '今、あなたはどこへ歩いて行きますか。', explanation: 'сейча́с があり、一方向の現在進行の移動なので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: 'よく、歩いて公園へ行くかを尋ねる', prompt: 'Ты ча́сто ___ в парк?', correctAnswer: 'хо́дишь', choices: ['идёшь', 'хо́дишь', 'е́дешь', 'е́здишь'], answerSentence: 'Ты ча́сто хо́дишь в парк?', answerTranslation: 'あなたはよく歩いて公園へ行きますか。', explanation: 'ча́сто による反復なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '今、乗り物でどこへ行くかを尋ねる', prompt: 'Куда́ вы сейча́с ___?', correctAnswer: 'е́дете', choices: ['идёте', 'хо́дите', 'е́дете', 'е́здите'], answerSentence: 'Куда́ вы сейча́с е́дете?', answerTranslation: '今、あなたたちは乗り物でどこへ向かっていますか。', explanation: '今一方向へ乗り物で移動中なので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: 'よく、バスでそこへ行くかを尋ねる', prompt: 'Вы ча́сто ___ туда́ на авто́бусе?', correctAnswer: 'е́здите', choices: ['идёте', 'хо́дите', 'е́дете', 'е́здите'], answerSentence: 'Вы ча́сто е́здите туда́ на авто́бусе?', answerTranslation: 'あなたたちはよくバスでそこへ行きますか。', explanation: '反復的な乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて家へ帰る', prompt: 'Он сейча́с ___ домо́й.', correctAnswer: 'идёт', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Он сейча́с идёт домо́й.', answerTranslation: '彼は今、歩いて家へ帰っています。', explanation: '今一方向へ歩いて帰っているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: 'ときどき、歩いて仕事へ行く', prompt: 'Он иногда́ ___ на рабо́ту пешко́м.', correctAnswer: 'хо́дит', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Он иногда́ хо́дит на рабо́ту пешко́м.', answerTranslation: '彼はときどき、歩いて仕事へ行きます。', explanation: 'иногда́ による反復なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '今、地下鉄で中心街へ向かう', prompt: 'Она́ сейча́с ___ в це́нтр на метро́.', correctAnswer: 'е́дет', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Она́ сейча́с е́дет в це́нтр на метро́.', answerTranslation: '彼女は今、地下鉄で中心街へ向かっています。', explanation: '今一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '毎週土曜日、乗り物で祖母のところへ行く', prompt: 'Она́ ка́ждую суббо́ту ___ к ба́бушке.', correctAnswer: 'е́здит', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Она́ ка́ждую суббо́ту е́здит к ба́бушке.', answerTranslation: '彼女は毎週土曜日、乗り物で祖母のところへ行きます。', explanation: '毎週繰り返す乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて店へ行く', prompt: 'Они́ сейча́с ___ в магази́н.', correctAnswer: 'иду́т', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с иду́т в магази́н.', answerTranslation: '彼らは今、歩いて店へ向かっています。', explanation: '今一方向へ歩いて移動中なので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: 'よく、歩いて映画館へ行く', prompt: 'Они́ ча́сто ___ в кино́.', correctAnswer: 'хо́дят', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ ча́сто хо́дят в кино́.', answerTranslation: '彼らはよく歩いて映画館へ行きます。', explanation: '反復的に歩いて行く意味なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '今、乗り物で駅へ向かう', prompt: 'Они́ сейча́с ___ на вокза́л.', correctAnswer: 'е́дут', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с е́дут на вокза́л.', answerTranslation: '彼らは今、乗り物で駅へ向かっています。', explanation: '今一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '毎年、乗り物で海へ行く', prompt: 'Они́ ка́ждый год ___ на мо́ре.', correctAnswer: 'е́здят', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ ка́ждый год е́здят на мо́ре.', answerTranslation: '彼らは毎年、乗り物で海へ行きます。', explanation: '毎年繰り返す乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて博物館へ行く', prompt: 'Мы сейча́с ___ в музе́й.', correctAnswer: 'идём', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы сейча́с идём в музе́й.', answerTranslation: '私たちは今、歩いて博物館へ向かっています。', explanation: '今一方向へ歩いているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: 'ときどき、歩いて博物館へ行く', prompt: 'Мы иногда́ ___ в музе́й пешко́м.', correctAnswer: 'хо́дим', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы иногда́ хо́дим в музе́й пешко́м.', answerTranslation: '私たちはときどき、歩いて博物館へ行きます。', explanation: '反復的な徒歩移動なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '今、タクシーで友人のところへ向かう', prompt: 'Я сейча́с ___ к дру́гу на такси́.', correctAnswer: 'е́ду', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Я сейча́с е́ду к дру́гу на такси́.', answerTranslation: '私は今、タクシーで友人のところへ向かっています。', explanation: '今一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: 'ときどき、タクシーで友人のところへ行く', prompt: 'Я иногда́ ___ к дру́гу на такси́.', correctAnswer: 'е́зжу', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Я иногда́ е́зжу к дру́гу на такси́.', answerTranslation: '私はときどき、タクシーで友人のところへ行きます。', explanation: '反復的な乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
]
