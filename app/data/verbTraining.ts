...
const motionSeeds: ExtraQuestion[] = [
  ...
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて店へ行く', prompt: 'Они́ сейча́с ___ в магази́н.', correctAnswer: 'иду́т', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с иду́т в магази́н.', answerTranslation: '彼らは今、歩いて店へ行きます。', explanation: '今一方向へ歩いて移動中なので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  ...
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて博物館へ行く', prompt: 'Мы сейча́с ___ в музе́й.', correctAnswer: 'идём', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы сейча́с идём в музе́й.', answerTranslation: '私たちは今、歩いて博物館へ行きます。', explanation: '今一方向へ歩いているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
