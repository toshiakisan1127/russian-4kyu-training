...
const motionSeeds: ExtraQuestion[] = [
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて学校へ行く', prompt: 'Сейча́с я ___ в шко́лу.', correctAnswer: 'иду́', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Сейча́с я иду́ в шко́лу.', answerTranslation: '今、私は歩いて学校へ向かっています。', explanation: 'сейча́с「今」+一方向に歩く動作なので、идти́の現在形иду́。' },
  ...
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いてどこへ行くかを尋ねる', prompt: 'Куда́ ты сейча́с ___?', correctAnswer: 'идёшь', choices: ['идёшь', 'хо́дишь', 'е́дешь', 'е́здишь'], answerSentence: 'Куда́ ты сейча́с идёшь?', answerTranslation: '今、あなたはどこへ歩いて行きますか。', explanation: 'сейча́с「今」の一方向の徒歩移動を尋ねているので、идти́のты形идёшь。' },
  { infinitive: 'идти́ / ходи́ть', meaning: 'よく、歩いて公園へ行くかを尋ねる', prompt: 'Ты ча́сто ___ в парк?', correctAnswer: 'хо́дишь', choices: ['идёшь', 'хо́дишь', 'е́дешь', 'е́здишь'], answerSentence: 'Ты ча́сто хо́дишь в парк?', answerTranslation: 'あなたはよく歩いて公園へ行きますか。', explanation: 'ча́сто「よく」と反復する徒歩移動を尋ねているので、ходи́тьのты形хо́дишь。' },
  { infinitive: 'е́хать / е́здить', meaning: '今、乗り物でどこへ行くかを尋ねる', prompt: 'Куда́ вы сейча́с ___?', correctAnswer: 'е́дете', choices: ['идёте', 'хо́дите', 'е́дете', 'е́здите'], answerSentence: 'Куда́ вы сейча́с е́дете?', answerTranslation: '今、あなたたちは乗り物でどこへ向かっていますか。', explanation: 'сейча́с「今」の一方向の乗り物移動を尋ねているので、е́хатьのвы形е́дете。' },
  ...
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて家へ帰る', prompt: 'Он сейча́с ___ домо́й.', correctAnswer: 'идёт', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Он сейча́с идёт домо́й.', answerTranslation: '彼は今、歩いて家へ帰っています。', explanation: 'сейча́с「今」の一方向の徒歩移動なので、идти́のон形идёт。' },
  ...
  { infinitive: 'е́хать / е́здить', meaning: '毎週土曜日、乗り物で祖母のところへ行く', prompt: 'Она́ ка́ждую суббо́ту ___ к ба́бушке.', correctAnswer: 'е́здит', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Она́ ка́ждую суббо́ту е́здит к ба́бушке.', answerTranslation: '彼女は毎週土曜日、乗り物で祖母のところへ行きます。', explanation: 'ка́ждую суббо́ту「毎週土曜日」と反復する乗り物移動なので、е́здитьのона́形е́здит。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて店へ行く', prompt: 'Они́ сейча́с ___ в магази́н.', correctAnswer: 'иду́т', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с иду́т в магази́н.', answerTranslation: '彼らは今、歩いて店へ向かっています。', explanation: 'сейча́с「今」の一方向の徒歩移動なので、идти́のони́形иду́т。' },
  ...
  { infinitive: 'е́хать / е́здить', meaning: '今、乗り物で駅へ向かう', prompt: 'Они́ сейча́с ___ на вокза́л.', correctAnswer: 'е́дут', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с е́дут на вокза́л.', answerTranslation: '彼らは今、乗り物で駅へ向かっています。', explanation: 'сейча́с「今」の一方向の乗り物移動なので、е́хатьのони́形е́дут。' },
  { infinitive: 'е́хать / е́здить', meaning: '毎年、乗り物で海へ行く', prompt: 'Они́ ка́ждый год ___ на мо́ре.', correctAnswer: 'е́здят', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ ка́ждый год е́здят на мо́ре.', answerTranslation: '彼らは毎年、乗り物で海へ行きます。', explanation: 'ка́ждый год「毎年」と反復する乗り物移動なので、е́здитьのони́形е́здят。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '今、歩いて博物館へ行く', prompt: 'Мы сейча́с ___ в музе́й.', correctAnswer: 'идём', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы сейча́с идём в музе́й.', answerTranslation: '私たちは今、歩いて博物館へ向かっています。', explanation: 'сейча́с「今」の一方向の徒歩移動なので、идти́のмы形идём。' },
