...
const motionSeeds: ExtraQuestion[] = [
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Сейча́с я ___ в шко́лу.', correctAnswer: 'иду́', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Сейча́с я иду́ в шко́лу.', explanation: '今まさに一方向へ歩いて移動しているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Я ка́ждый день ___ в шко́лу пешко́м.', correctAnswer: 'хожу́', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Я ка́ждый день хожу́ в шко́лу пешко́м.', explanation: '習慣的・反復的に歩いて行くので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Сейча́с мы ___ в Москву́ на по́езде.', correctAnswer: 'е́дем', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Сейча́с мы е́дем в Москву́ на по́езде.', explanation: '今まさに一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Мы ча́сто ___ в Москву́ на по́езде.', correctAnswer: 'е́здим', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы ча́сто е́здим в Москву́ на по́езде.', explanation: '繰り返し乗り物で行くので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Куда́ ты сейча́с ___?', correctAnswer: 'идёшь', choices: ['идёшь', 'хо́дишь', 'е́дешь', 'е́здишь'], answerSentence: 'Куда́ ты сейча́с идёшь?', explanation: 'сейча́с があり、一方向の現在進行の移動なので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Ты ча́сто ___ в парк?', correctAnswer: 'хо́дишь', choices: ['идёшь', 'хо́дишь', 'е́дешь', 'е́здишь'], answerSentence: 'Ты ча́сто хо́дишь в парк?', explanation: 'ча́сто による反復なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Куда́ вы сейча́с ___?', correctAnswer: 'е́дете', choices: ['идёте', 'хо́дите', 'е́дете', 'е́здите'], answerSentence: 'Куда́ вы сейча́с е́дете?', explanation: '今一方向へ乗り物で移動中なので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Вы ча́сто ___ туда́ на авто́бусе?', correctAnswer: 'е́здите', choices: ['идёте', 'хо́дите', 'е́дете', 'е́здите'], answerSentence: 'Вы ча́сто е́здите туда́ на авто́бусе?', explanation: '反復的な乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Он сейча́с ___ домо́й.', correctAnswer: 'идёт', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Он сейча́с идёт домо́й.', explanation: '今一方向へ歩いて帰っているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Он иногда́ ___ на рабо́ту пешко́м.', correctAnswer: 'хо́дит', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Он иногда́ хо́дит на рабо́ту пешко́м.', explanation: 'иногда́ による反復なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Она́ сейча́с ___ в це́нтр на метро́.', correctAnswer: 'е́дет', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Она́ сейча́с е́дет в це́нтр на метро́.', explanation: '今一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Она́ ка́ждую суббо́ту ___ к ба́бушке.', correctAnswer: 'е́здит', choices: ['идёт', 'хо́дит', 'е́дет', 'е́здит'], answerSentence: 'Она́ ка́ждую суббо́ту е́здит к ба́бушке.', explanation: '毎週繰り返す乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Они́ сейча́с ___ в магази́н.', correctAnswer: 'иду́т', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с иду́т в магази́н.', explanation: '今一方向へ歩いて移動中なので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Они́ ча́сто ___ в кино́.', correctAnswer: 'хо́дят', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ ча́сто хо́дят в кино́.', explanation: '反復的に歩いて行く意味なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Они́ сейча́с ___ на вокза́л.', correctAnswer: 'е́дут', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ сейча́с е́дут на вокза́л.', explanation: '今一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Они́ ка́ждый год ___ на мо́ре.', correctAnswer: 'е́здят', choices: ['иду́т', 'хо́дят', 'е́дут', 'е́здят'], answerSentence: 'Они́ ка́ждый год е́здят на мо́ре.', explanation: '毎年繰り返す乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Мы сейча́с ___ в музе́й.', correctAnswer: 'идём', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы сейча́с идём в музе́й.', explanation: '今一方向へ歩いているので идти́。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'идти́ / ходи́ть', meaning: '歩いて行く', prompt: 'Мы иногда́ ___ в музе́й пешко́м.', correctAnswer: 'хо́дим', choices: ['идём', 'хо́дим', 'е́дем', 'е́здим'], answerSentence: 'Мы иногда́ хо́дим в музе́й пешко́м.', explanation: '反復的な徒歩移動なので ходи́ть。まとめ：一方向の徒歩移動は идти́、反復・習慣の徒歩移動は ходи́ть。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Я сейча́с ___ к дру́гу на такси́.', correctAnswer: 'е́ду', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Я сейча́с е́ду к дру́гу на такси́.', explanation: '今一方向へ乗り物で移動しているので е́хать。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
  { infinitive: 'е́хать / е́здить', meaning: '乗り物で行く', prompt: 'Я иногда́ ___ к дру́гу на такси́.', correctAnswer: 'е́зжу', choices: ['иду́', 'хожу́', 'е́ду', 'е́зжу'], answerSentence: 'Я иногда́ е́зжу к дру́гу на такси́.', explanation: '反復的な乗り物移動なので е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。まとめ：一方向の乗り物移動は е́хать、反復・習慣の乗り物移動は е́здить。' },
]
